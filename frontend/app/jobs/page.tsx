      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 py-16 text-center">
            ...
            <button
              onClick={() => router.push('/jobs/new')}
              className="bg-[#1B4F8A] text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[#133A66]"
            >
            ...
            {jobs.map(job => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={e => { e.stopPropagation(); router.push(`/jobs/${job.id}/upload`) }}
                    className="flex items-center gap-1.5 text-[#1B4F8A] border border-[#1B4F8A] px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-blue-50 transition"
                  >
